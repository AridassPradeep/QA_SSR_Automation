...
public class ProductLandingPage {
	...
	public boolean validateReset() throws InterruptedException {
		Thread.sleep(2000);
		return driver.findElement(By.xpath("//div[@class='reset-product-list']")).isEnabled();

	}

	public void clickReset() throws InterruptedException {

		driver.findElement(By.xpath("//div[@class='reset-product-list']")).click();
	...
	public void verifyFilterColorCoated() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[contains(@value,'15965:2012')]")).isDisplayed();
		driver.findElement(By.xpath("//label[contains(text(),'15965:2012')]")).click();
	}
	...
	{
		driver.findElement(By.xpath("//div[contains(text(),'Clear filters')]")).click();
	}
