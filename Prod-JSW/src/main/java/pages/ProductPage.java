...
public class ProductPage {
	...
	public void selectProductreguserHRS() {
		...
		for (int i = 0; i < productlist.size(); i++) {
			...
			if (productlist.get(i).getText().equals("//span[contains(text(),'Jindal Stainless HR 304L N1 Finish Sheets')]")) {
	...
	public void clickCustomerLength() throws InterruptedException {
		driver.findElement(By.xpath("//*[contains(text(),'Custom length ')]")).click();
		Thread.sleep(2000);
