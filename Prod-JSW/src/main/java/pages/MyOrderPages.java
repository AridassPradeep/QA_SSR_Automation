...
//Filter Functionality
	...
	public void couponsCount() {
		WebElement count = driver.findElement(By.xpath("//div[@class='selected-coupons']"));
...
//Filter Functionality
	...
	public void verifyMyOrderPage() {
		// return driver.findElement(By.xpath("//a[normalize-space()='My
		// orders']")).getText();
	...
	public String getOrderNo() {
		String orderNo = driver.findElement(By.xpath("//div[normalize-space()='Order number']//following::div[1]"))
				.getText();
	...
	public void validateOrderAwaitingPayment() {

		driver.findElement(By.xpath("//*[text()='Orders awaiting payment']")).isDisplayed();
