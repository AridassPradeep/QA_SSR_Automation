...
public class PaymentSteps {
	...
	public void cart_is_empty_or_notDirectOrder() throws Exception {
		if (pmtpage.isElementPresent())

		{

			pmtpage.deleteDirectOrderProductfromCart() ;
		}
	}
	...
	public void user_navigates_to_razor_pay_page() throws InterruptedException {
		String title = pmtpage.validateRazorpayPage();
		Assert.assertEquals(title, "Welcome to HDFC Bank Direct Pay");
	}
	...
	public void user_clicks_on_neftrtgs() throws Throwable {
		pmtpage.clickNEFT();
	}
