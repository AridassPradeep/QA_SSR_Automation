...
public class MyOrderPageSteps {
	...
	private OrderSummaryPage orderSummry = new OrderSummaryPage(DriverFactory.getDriver());
	...
	public void user_is_able_to_click_view_price_breakup_button_to_view_detailed_cost_list_of_the_ordered_product()
	...
	public void user_is_able_to_scroll_down_and_click_buy_again_which_was_shown_in_the_ordered_product()
			throws InterruptedException {
...
//Filter Functionality
	...
	public void user_is_able_select_the_custom_date_range_of_ordered_products_to_be_displayed()
			throws InterruptedException {
	...
	public void user_is_able_to_select_the_pre_defined_duration_range_of_ordered_products_to_be_filtered()
			throws InterruptedException {
		order.durationDefault();
	...
	@When("verify the order generated is dispalying in MyordersPage")
	public void verify_the_order_generated_is_dispalying_in_myorders_page() throws InterruptedException {
		orderSummry.validateOrderNoinDisplayedinOrderPage();
	}
